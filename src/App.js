...
<div className="input-group rounded ">
  ...
  <button className="input-group-text border-0 rounded-0 bg-dark text-white btn" id="search-addon">
    <i className="bi bi-search"></i>
              ...
              { isSuccess === true ? (
                <li className="nav-item">
                <p className="nav-link btn btn-light text-black p-2" onClick={() => userLogout()} >LogOut</p>
              </li>
              ) : (
                <li className="nav-item">
                <NavLink className="nav-link btn btn-light text-black p-2" to="loginsignup/customerlogin">LogIn</NavLink>
              </li>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <div className="py-4 px-3 mb-4 bg-light">
    <div className="media d-flex align-items-center"><img src="https://bootstrapious.com/i/snippets/sn-v-nav/avatar.png" alt="..." width="90" className="mr-3 rounded-circle img-thumbnail shadow-sm " />
      <div className="media-body">
        <h4 className="m-0"> Jason Doe</h4>
        <p className="font-weight-light text-muted mb-0"> Customer</p>
      </div>
    </div>
  </div>
